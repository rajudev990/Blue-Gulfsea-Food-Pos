                    ...
                    <form id="quickForm" method="POST" action="{{ route('admin.customers.update',$data->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input value="{{$data->email}}" type="email" id="email" name="email" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input value="{{$data->address}}" type="address" id="address" name="address" value="{{ old('address') }}" class="form-control @error('address') is-invalid @enderror">
